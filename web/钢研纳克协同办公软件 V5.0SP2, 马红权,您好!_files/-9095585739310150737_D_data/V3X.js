...
function editAttachments(atts,reference,subReference,category){
	...
	var result = v3x.openWindow({
		url		: getA8Top().v3x.baseURL + "/genericController.do?ViewPage=common/fileUpload/attEdit&category="
		+category+"&reference="+reference+"&subReference="+subReference+"&_isModalDialog=true",
		width	: 550,
		height	: 430,
		resizable	: "yes"
	});
